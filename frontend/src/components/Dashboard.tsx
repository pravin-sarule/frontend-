...
//   // Check if current route is AI Assistant
...
//         {isAIAssistant ? (
//           // For AI Assistant: Full-width layout without margins or padding
//           <main className="flex-1 h-full overflow-hidden">
//             <Outlet />
//           </main>
//         ) : (
//           // For other routes: Traditional layout with margins and padding
//           <main className={`flex-1 transition-all duration-300 ease-out ${isSidebarCollapsed ? 'lg:ml-20' : 'lg:ml-80'}`}>
//             <div className="p-8 animate-fade-in">
//               <div className="max-w-7xl mx-auto">
//                 <Outlet />
